...

{
...

  {
...

    {
      ...
      Rectangle p = new Rectangle(); // creating and initializing the object of Rectangle class.

      int choice, length, width;// initialize parameters
...

      {
        ...
        if ((!int.TryParse(Console.ReadLine(), out choice) || choice <= 0 || choice > 7))// check user input
        ...
        switch (choice) // used to jump on a particular case
